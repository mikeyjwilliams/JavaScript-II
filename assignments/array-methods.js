...
let fullName = [];
const names = runners.forEach(name => {
...
let allCaps = [];
allCaps = runners.map(firstName => firstName.first_name.toUpperCase());
//console.log(allCaps);
...
ticketPriceTotal = runners.reduce(function (startValue, currentval) {
    return startValue + currentval.donation;
}, 0);
